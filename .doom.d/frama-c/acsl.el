...
;;   "Init keymap"
;;   (define-key acsl-mode-map "\C-c\C-j" 'acsl-frama-c-wp-gui))
...
(defcustom acsl-frama-c-wp-gui-prog-name "frama-c-gui -wp"
  "Frama-C/WP executable name."
  :group 'acsl
  :type 'string)
...
(define-derived-mode acsl-mode c-mode
  ...
  (setq-local compile-command
              (concat acsl-frama-c-wp-gui-prog-name
                      " "
                      (buffer-file-name)))
  (acsl-font-lock-init)
  ;; (acsl-keymap-init)
