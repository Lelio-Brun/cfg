...
values."
  (setq-default
   ...
   ;; Ifhelm non-nil then Spacemacs will ask for confirmation before installing
   ;; a layer lazily. (default t)
   dohelmtspacemacs-ask-for-lazy-installation t
   ...
   dotspacemacs-additional-packages '(color)
...
(custom-set-faces
 ...
 '(company-scrollbar-bg ((t (:background "#389740ac4d9b"))))
 '(company-scrollbar-fg ((t (:background "#2dcb34563ecd"))))
 '(company-tooltip ((t (:inherit default :background "#27512cef35eb"))))
 '(company-tooltip-annotation ((t (:inherit font-lock-type-face))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-selection ((t (:inherit font-lock-function-name-face)))))
